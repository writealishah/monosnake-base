export const baseAppConfig = {
  ...
  coverImagePath: "/assets/screenshots/hero-placeholder.png",
  heroImagePath: "/assets/screenshots/hero-placeholder.png",
  ogTitle: "MonoSnake Base",
  ogDescription: "Retro handheld Snake with onchain best scores on Base.",
  ogImagePath: "/assets/screenshots/hero-placeholder.png",
